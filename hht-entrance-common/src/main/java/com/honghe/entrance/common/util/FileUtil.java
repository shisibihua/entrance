...
public final class FileUtil {
    ...
    public static String uploadFile(byte[] file, String filePath, String fileName) throws Exception{
        ...
        String newFileName=MD5Util.MD5(fileName).toLowerCase()+fileName.substring(fileName.lastIndexOf("."));
        FileOutputStream out = new FileOutputStream(filePath+File.separator+newFileName);
        out.write(file);
        out.flush();
        out.close();
        return newFileName;
