...
public class ParamUtil {
    ...
    public static  Map<String, Object> getParams(HttpServletRequest request) {
        ...
        if ((request.getMethod().equalsIgnoreCase("GET")) ||(type != null &&  !type.contains("application/json"))) {
            parameters = request.getParameterMap();
            params=getResultMap(parameters);
        } else {
            try {
                ...
                if(params==null){
                    params = new HashMap<>();
                    params=getResultMap(request.getParameterMap());
                }
            } catch (IOException e) {
    ...
    private static Map<String, Object> getResultMap(Map<String, String[]> parameters) {
        Map<String, Object> params = new HashMap<>();
        int len;
